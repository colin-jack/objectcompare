var shouldCompareAndIdentifyDifferencesExist = function(first, second, expectedDifferences) {
    var result;
    ...
    it('should identify correct differences', function(){      
      var expectedDiffProperties = Object.keys(expectedDifferences);
        ...
        expectedDiffProperties.forEach(function(expectedDiffProperty) {
            assert.isTrue(expectedDiffProperty in result.differences, "Expected there to be a difference for: " + expectedDiffProperty);
